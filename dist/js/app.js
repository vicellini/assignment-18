...
function controllerRouter() {
	...
	if (currentRoute === 'concerts') {
		console.log("heyy");
		_jquery2.default.getJSON('http://apis.is/concerts').then(function (serverRes) {
	...
	if (currentRoute === 'carpools') {
		_jquery2.default.getJSON('http://apis.is/rides/samferda-drivers/').then(function (serverRes) {
			var resultObj = serverRes.results;
			var bigHTML = '';
			UTILS.forEach(resultObj, function (eachObj, i) {
	...
	if (currentRoute === 'flights') {
		...
		var arrivalFetch = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals');
		var departureFetch = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=departures');
		_jquery2.default.when(arrivalFetch, departureFetch).then(function (arrivalData, departureData) {
...
},{"./utils.js":3,"jquery":1}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var forEach = exports.forEach = function forEach(arr, func) {
  for (var i = 0; i < arr.length; i++) {
    func(arr[i], i, arr);
  }
};

var isDefined = exports.isDefined = function isDefined(someStr) {
  if (someStr === '') {
    someStr = "N/A";
  }
  return someStr;

...
navContainerEl.addEventListener('click', function (evt) {
	...
	function controllerRouter() {
		...
		if (currentRoute === 'flights') {
			...
			_jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals').then(function (serverRes) {
				var resultObj = serverRes.results;
				...
				UTILS.forEach(resultObj, function (arrivalObj, i) {
			...
			_jquery2.default.getJSON('http://apis.is/flight?language=en&type=departures').then(function (serverRes) {
				var resultObj = serverRes.results;
				var departureBigHTML = '\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<table class="flight_table">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr class="table-label">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th><strong>Date</strong></th>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th><strong>Departure Time</strong></th>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th><strong>Destination</strong></th>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th><strong>Airline</strong></th>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>';
				UTILS.forEach(resultObj, function (departureObj, i) {
